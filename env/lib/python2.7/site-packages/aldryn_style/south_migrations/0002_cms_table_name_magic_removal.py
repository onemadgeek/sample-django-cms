...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if 'cmsplugin_style' in table_names:
            db.rename_table('cmsplugin_style', 'aldryn_style_style')

    def backwards(self, orm):
        table_names = connection.introspection.table_names()
        if 'aldryn_style_style' in table_names:
            db.rename_table('aldryn_style_style', 'cmsplugin_style')
